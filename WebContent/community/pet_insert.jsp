...
<meta charset="UTF-8">
<title>펫 정보 입력</title>
<link rel= "stylesheet" href="../css/petsitter.css?v=3">
	...
	<form name = "petinsert" method="post" action="../petInsert.do">
		<script>
			function submit2(frm) {
				frm.action="../p_multi_write.do"
				frm.value="${user.idx}"
				frm.submit();
				return true;
			}
		</script>
		<input type="hidden" name="idx" value="${user.idx}">	<!-- 세션의 idx값 action으로 넘겨주기 -->
		<table>
			<br><br><br><br><br><br>
			<tr>
				<th>이름</th>
			...
			<tr>
				...
				<button type="button" value="뒤로가기" class="b_btn" style="vertical-align:middle" onclick="location.href='../index.do'"><span>뒤로가기</span></button>
